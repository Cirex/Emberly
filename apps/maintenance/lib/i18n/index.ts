...
const en = {
  ...
  outbox: {
    title: "Outbox",
    waiting_one: "{{count}} waiting to reach ResMan",
    waiting_other: "{{count}} waiting to reach ResMan",
    allDelivered: "All changes delivered",
    syncNow: "Sync now",
    sending: "Sending…",
  ...
  workOrders: {
    ...
    dates: {
      ...
      clear: "Clear",
      set: "Set",
      scheduledTitle: "Scheduled visit",
      scheduledSubtitle: "When #{{number}} · {{unit}} is booked for.",
      completedTitle: "Completed",
      completedSubtitle: "Stamping a completion date closes #{{number}}.",
      confirmClose: "Close",
      cancelClose: "Cancel close",
      noNotesTitle: "No technician notes",
      noNotesBody:
        "#{{number}} has no technician notes. Closing it now leaves no record of what was done.",
      addNotes: "Add notes",
      closeAnyway: "Close anyway",
    },
    detail: {
      notFoundTitle: "Work order not found",
      notFoundBody: "It may not be in the cached set yet. Pull to refresh the list and try again.",
      back: "Back",
      close: "Close",
      eyebrow: "Work order #{{number}}",
      eyebrowReported: "Reported {{date}}",
      occupiedDays_one: "{{count}} day",
      occupiedDays_other: "{{count}} days",
      closedInDays_one: "Closed in {{count}} day",
      closedInDays_other: "Closed in {{count}} days",
      openDays_one: "Open {{count}} day",
      openDays_other: "Open {{count}} days",
      chips: {
      ...
      noDescription: "No description. Tap to add one.",
      reassignA11y: "Reassign; currently {{name}}",
      ...
      journey: {
        ...
        unset: "—",
        notSet: "not set",
        changeA11y: "{{label}}: {{value}}. Tap to change.",
      },
    },
  },
  preventive: {
  ...
  mapGroups: {
    ...
    paintToggle: "Paint the map by groups",
  ...
  utility: {
    ...
    titleWithCount_one: "Utilities · {{count}} run",
    titleWithCount_other: "Utilities · {{count}} runs",
    typeSection: "Type",
    colorSection: "Color",
    iconSection: "Icon",
    layerToggle: "Show the utility layer on the map",
    newRun: "New run",
    newPin: "New pin",
    finish: "Finish",
    drawingRun: "Drawing {{type}} run",
    placingPin: "Placing {{type}} pin",
    lineSection: "Line",
    styleSolid: "Solid",
    styleDashed: "Dashed",
    styleDotted: "Dotted",
  ...
  insights: {
    ...
    categoryMix: "Trade mix",
    categoryMixSub: "{{count}} closures in 90 days · a job can carry more than one trade",
    otherCategory: "Other",
  },
  scoreCards: {
  ...
  jobTime: {
    section: "Time & parts",
    onThisJob: "On this job",
    start: "Start",
    resume: "Resume",
    pause: "Pause",
    partsUsed: "Parts used",
    noParts: "No parts logged yet.",
    addPart: "Add part",
    addPartPlaceholder: "Add a part…",
    removePart: "Remove part",
    increase: "Increase quantity",
    decrease: "Decrease quantity",
    heldOnDevice: "Held on this device until closed work orders sync to ResMan.",
  },
  dictation: {
    listening: "Listening…",
  ...
  myWeek: {
    ...
    callbackRate: "Callback rate",
    onRouteToday: "On route today",
    closesPerDay: "Closes per day",
    sameAsLastWeek: "Same as last week",
    upVsLastWeek: "▲ {{count}} vs last week",
    downVsLastWeek: "▼ {{count}} vs last week",
    lastWeekWas: "Last week {{value}}",
    nothingClosed: "Nothing closed yet",
    tooFewToRate: "Too few jobs to rate",
    callbacksInDays_one: "{{count}} in {{days}} days",
    callbacksInDays_other: "{{count}} in {{days}} days",
    urgentCount_one: "{{count}} urgent",
    urgentCount_other: "{{count}} urgent",
    noneUrgent: "None urgent",
    streakDays_one: "{{count}} day without a callback",
    streakDays_other: "{{count}} days without a callback",
    streakClean: "No callbacks in {{days}} days",
...
const es: typeof en = {
  ...
  settings: {
    ...
    resmanSession: "Sesión de ResMan",
  ...
  outbox: {
    ...
    waiting_one: "{{count}} en camino a ResMan",
    waiting_other: "{{count}} en camino a ResMan",
    allDelivered: "Todos los cambios entregados",
    syncNow: "Sincronizar",
    sending: "Enviando…",
    ...
    item: {
      markedComplete: "Marcada como completa",
  ...
  workOrders: {
    ...
    dates: {
      ...
      clear: "Quitar",
      set: "Guardar",
      scheduledTitle: "Visita programada",
      scheduledSubtitle: "Para cuándo está agendada la #{{number}} · {{unit}}.",
      completedTitle: "Completada",
      completedSubtitle: "Poner una fecha de finalización cierra la #{{number}}.",
      confirmClose: "Cerrar",
      cancelClose: "Deshacer cierre",
      noNotesTitle: "Sin notas del técnico",
      noNotesBody:
        "La #{{number}} no tiene notas del técnico. Cerrarla ahora no deja constancia de lo que se hizo.",
      addNotes: "Agregar notas",
      closeAnyway: "Cerrar de todos modos",
    },
    detail: {
      notFoundTitle: "Orden de trabajo no encontrada",
      notFoundBody:
        "Puede que aún no esté en los datos guardados. Desliza para actualizar la lista e inténtalo de nuevo.",
      back: "Atrás",
      close: "Cerrar",
      eyebrow: "Orden de trabajo n.º {{number}}",
      eyebrowReported: "Reportada {{date}}",
      occupiedDays_one: "{{count}} día",
      occupiedDays_other: "{{count}} días",
      closedInDays_one: "Cerrada en {{count}} día",
      closedInDays_other: "Cerrada en {{count}} días",
      openDays_one: "Abierta {{count}} día",
      openDays_other: "Abierta {{count}} días",
      chips: {
      ...
      sections: {
        ...
        relatedWorkOrders: "Órdenes relacionadas",
      },
      noDescription: "Sin descripción. Toca para agregar una.",
      reassignA11y: "Reasignar; actualmente {{name}}",
      ...
      journey: {
        ...
        unset: "—",
        notSet: "sin definir",
        changeA11y: "{{label}}: {{value}}. Toca para cambiar.",
      },
    },
  },
  preventive: {
  ...
  mapGroups: {
    ...
    paintToggle: "Pintar el mapa por grupos",
  ...
  utility: {
    ...
    titleWithCount_one: "Servicios · {{count}} línea",
    titleWithCount_other: "Servicios · {{count}} líneas",
    typeSection: "Tipo",
    colorSection: "Color",
    iconSection: "Ícono",
    layerToggle: "Mostrar la capa de servicios en el mapa",
    newRun: "Nueva línea",
    newPin: "Nuevo pin",
    finish: "Terminar",
    drawingRun: "Dibujando línea de {{type}}",
    placingPin: "Colocando pin de {{type}}",
    lineSection: "Línea",
    styleSolid: "Sólida",
  ...
  insights: {
    ...
    categoryMix: "Mezcla por oficio",
    categoryMixSub: "{{count}} cierres en 90 días · un trabajo puede tener más de un oficio",
    otherCategory: "Otras",
  },
  scoreCards: {
  ...
  jobTime: {
    section: "Tiempo y piezas",
    onThisJob: "En este trabajo",
    start: "Iniciar",
    resume: "Reanudar",
    pause: "Pausar",
    partsUsed: "Piezas usadas",
    noParts: "Aún no hay piezas registradas.",
    addPart: "Agregar pieza",
    addPartPlaceholder: "Agregar una pieza…",
  ...
  myWeek: {
    ...
    closed: "Cerradas",
    medianClose: "Cierre mediano",
    callbackRate: "Reincidencia",
    onRouteToday: "En ruta hoy",
    closesPerDay: "Cierres por día",
    sameAsLastWeek: "Igual que la semana pasada",
    upVsLastWeek: "▲ {{count}} vs. semana pasada",
    downVsLastWeek: "▼ {{count}} vs. semana pasada",
    lastWeekWas: "Semana pasada {{value}}",
    nothingClosed: "Nada cerrado aún",
    tooFewToRate: "Muy pocos trabajos para calcular",
    callbacksInDays_one: "{{count}} en {{days}} días",
    callbacksInDays_other: "{{count}} en {{days}} días",
    urgentCount_one: "{{count}} urgente",
    urgentCount_other: "{{count}} urgentes",
    noneUrgent: "Ninguna urgente",
    streakDays_one: "{{count}} día sin reincidencias",
    streakDays_other: "{{count}} días sin reincidencias",
    streakClean: "Sin reincidencias en {{days}} días",
    lastWeekRange: "Semana pasada · {{range}}",
  },
  myDay: {
