...
/**
 * Sentry crash/error reporting for the manager app.
 *
 * This is a SEPARATE Sentry project from the web, resident, and maintenance
 * apps — each surface reports to its own DSN. The DSN comes from
