              ...
              {EXPIRY.map((o) => {
                ...
                return (
                  <Pressable
                    ...
                    style={{ flexDirection: "row", alignItems: "center", gap: 10, padding: 11, borderRadius: 12, borderWidth: 1, borderColor: on ? "#A2A921" : "rgba(9,27,84,0.14)", backgroundColor: on ? "rgba(162,169,33,0.12)" : "transparent" }}
                  >
