...
/**
 * Scanner-side client for the layered map annotations. The server confines a
 * scanner credential to the 'security' layer, so nothing here names layers —
 * whatever this device reads or writes is security-layer by construction.
 */
