-- ============================================================================
-- mcp_aggregate: allow monitor_findings
-- ============================================================================
--
-- Supersedes 2026-07-31-mcp-aggregate-unit-snapshots.sql, which is applied and
-- therefore left as it ran. Only the table allowlist changes.
--
-- NOTE FOR FUTURE RESOURCES: a table exposed through the MCP registry but
-- absent from this allowlist still WORKS — aggregateResource falls back to the
-- PostgREST scan path — but silently loses the SQL grouping, which is the
-- difference between one request and thirty-three. Add the table here whenever
-- you add a resource.
